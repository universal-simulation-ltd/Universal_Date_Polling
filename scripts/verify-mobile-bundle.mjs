...
// asset URL comes out as `/polling/assets/...`, which on the phone is a 404: the
...
//
// It has happened — Universal PDF 0.6.14 shipped to a real iPhone that way and
// could not load. This script is that repo's guard, copied here so the same
