  ...
  return (
    <div ref={rootRef} className="relative inline-block text-left">
      <button
        ...
        aria-expanded={open}
        className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 h-9 text-sm text-slate-700 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-500 focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)] outline-none"
      >
      ...
      {open && (
        <div className="absolute left-0 z-40 mt-1.5 w-72 max-w-[85vw] rounded-lg bg-white dark:bg-slate-800 shadow-lg ring-1 ring-slate-200 dark:ring-slate-700 pop-in">
          <div className="p-2 border-b border-slate-100 dark:border-slate-700">
            <input
              ...
              className="w-full h-9 rounded-md border border-slate-300 dark:border-slate-700 px-2.5 text-sm text-slate-900 dark:text-slate-100 dark:bg-slate-900 focus:border-[var(--accent)] outline-none"
            />
          </div>
                ...
                return (
                  <li key={z}>
                    <button
                      ...
                      onClick={() => pick(z)}
                      className={`flex w-full items-center justify-between gap-2 px-3 py-1.5 text-left text-sm hover:bg-slate-50 dark:hover:bg-slate-700 ${selected ? 'font-semibold text-[var(--accent-text)]' : 'text-slate-700 dark:text-slate-300'}`}
                    >
